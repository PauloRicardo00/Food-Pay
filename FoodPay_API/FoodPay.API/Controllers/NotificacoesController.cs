...
namespace FoodPay.API.Controllers
{
    ...
    public class NotificacoesController : ControllerBase
    {
        ...
        // Marcar como lida — valida que a notificação pertence ao usuário logado
        [HttpPut("{id}/ler")]
        public async Task<IActionResult> MarcarComoLida(int id)
        {
            ...
            if (perfil == "aluno")
            {
                ...
                if (aluno == null || notificacao.AlunoId != aluno.Id)
                    return Forbid();
            }
            else if (perfil == "responsavel")
            {
                ...
                if (responsavel == null || notificacao.ResponsavelId != responsavel.Id)
                    return Forbid();
            }
            else
            {
