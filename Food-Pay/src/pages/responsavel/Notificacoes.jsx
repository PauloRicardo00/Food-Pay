/**
 * Notificações do responsável — consome GET /Notificacoes/minhas.
 * Permite marcar notificações individualmente ou em lote como lidas.
 */
...
function NotificacoesResponsavel() {
